...
def aicsDistMap(path, maskStartStop=None):
	"""
...
if __name__ == '__main__':
	maskPath = '/media/cudmore/data/san-density/SAN3/SAN3_head/aicsAnalysis/SAN3_head_ch1.tif'
	maskPath = '/media/cudmore/data/san-density/SAN3/SAN3_head/aicsAnalysis/SAN3_head_ch2.tif'
	aicsDistMap(maskPath)
